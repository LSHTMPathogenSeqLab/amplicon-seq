...
def main(args):
    ...
    for sample in samples:
        ...
        run_cmd("bcftools merge %(sample)s.freebayes.vcf.gz %(sample)s.gatk.vcf.gz --force-samples -Oz -o %(sample)s.vcf.gz" % vars(args))
...
#parser.add_argument('--position-info',type=str,help='Position info file',required=False)
